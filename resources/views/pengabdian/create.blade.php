...
@section('title', 'Form Tambah Berita Pengabdian')
...
@section('container')
    ...
    <section class="area-padding-bottom area-padding-top">
        <div class="container">
            <h2 class="mb-5">Form Tambah Berita Pengabdian</h2>
            <p><i>* Wajib diisi</i></p>
            
            <form method="post" action="{{url( '/admin/successlogin/pengabdian' )}}" enctype="multipart/form-data">
                @csrf
