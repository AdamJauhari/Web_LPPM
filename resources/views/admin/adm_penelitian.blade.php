                    ...
                    <div class="card-deck">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Daftar penelitian Universitas Cendekia Abditama</p>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Daftar pengabdian kepada masyarakat Universitas Cendekia Abditama</p>
                            </div>
                            <div class="card-footer">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Daftar publikasi peneliti Universitas Cendekia Abditama</p>
                            </div>
                            <div class="card-footer">
                    ...
                    <div class="card-deck mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Daftar kepakaran peneliti Universitas Cendekia Abditama</p>
                            </div>
                            <div class="card-footer">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Daftar Forum Komunikasi Ilmiah dan Conferences Universitas Cendekia Abditama</p>
                            </div>
                            <div class="card-footer">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Daftar produk riset Universitas Cendekia Abditama</p>
                            </div>
                            <div class="card-footer">
                    ...
                    <div class="card-deck mt-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Data paten Universitas Cendekia Abditama</p>
                            </div>
                            <div class="card-footer">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Data hak cipta Universitas Cendekia Abditama</p>
                            </div>
                            <div class="card-footer">
