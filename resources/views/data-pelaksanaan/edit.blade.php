@extends('layout.main')
@section('title', 'Edit Data Pelaksanaan - LPPM UCA')
@section('container')
            ...
            <div class="col-lg-7">
                <div class="submission-card">
                    <div class="submission-header">
                        ...
                        <h2>Edit Data Pelaksanaan</h2>
                        <p>Perbarui data pelaksanaan penelitian atau pengabdian</p>
                    </div>
                    @if ($errors->any())
                    ...
                    @endif
                    <form method="POST" action="{{ url('/data-pelaksanaan/'.$pelaksanaan->id) }}" class="submission-form">
                        @csrf @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" class="form-control" value="{{ old('judul', $pelaksanaan->judul) }}" required>
                        </div>
                        <div class="form-group">
                            <label><i class="fas fa-align-left"></i> Deskripsi Singkat</label>
                            <textarea name="deskripsi_singkat" class="form-control" rows="4" required>{{ old('deskripsi_singkat', $pelaksanaan->deskripsi_singkat) }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="url" name="url" class="form-control" value="{{ old('url', $pelaksanaan->url) }}">
                        </div>
